...
<div class="mid-wrap clearfix">
    ...
    <section id="section2">
        <div class="content-wrap">
            <main class="content">
                ...
                <article>
                    <p><span>The weather. The Food. The Drinks. The Beach.</span> You are in love with it all and now you want to learn more about Pacific Beach homes for sale and the questions start flowing:
                    </p>
                    <h2>Can I afford a home in Pacific Beach?</h2>
                    <p>I know what you are thinking. You either assume homes in Pacific Beach are expensive, or you already know it!
                    <br><br>
                    ...
                    <h2>What types of homes are for sale in Pacific Beach?</h2>
                    <p>Pacific Beach consists of houses, townhomes, condos and multi unit properties (think of duplexes, all the way up to apartment complexes). The mixture of these types of homes range from neighborhood to neighborhood within Pacific Beach. Northern Pacific Beach is predominantly single family houses perched atop the foot of Mount Soledad. Central Pacific Beach has a mix of houses, condos and multi-family units. Crown Point has mostly single family houses, with a couple large apartment complexes and condos mixed in. Mission Beach has homes situated on smaller pieces of land, creating a very dense lifestyle with incredible proximity to the water.
                    </p>
                    <h2>Which Pacific Beach neighborhood is right for me?</h2>
                    <p>This part can be tricky. If you are not currently living in Pacific Beach, you need to spend time learning the <a href="https://pacificbeachhomes.com/what-neighborhood-in-pacific-beach-is-best-for-you/">neighborhoods of PB</a>, or trust a <a href="https://pacificbeachhomes.com/real-estate-agent-pacific-beach/">Pacific Beach real estate agent</a> to help you. Pacific Beach is very unique because there are several abrupt changes in living situations as you move from block to block.
                    <br><br>
        ...
        <div class="sidebar-wrap">
            <div class="sidebar">
                <img src="/resources/images/sidebar/volleyball.jpg" alt="Pacific Beach Volleyball">
                <img class="lazy" src="https://ik.imagekit.io/y0qivtggs/pacific-beach-sunset__2QgRDVRpl.jpg?tr=w-400,h-600,bl-30,q-50" data-src="/resources/images/sidebar/pacific-beach-sunset.jpg" alt="Pacific Beach cliffs during sunset">
                <img class="lazy" src="https://ik.imagekit.io/y0qivtggs/crystal-pier-drone_-25QyiIjm.jpg?tr=w-400,h-600,bl-30,q-50" data-src="/resources/images/sidebar/crystal-pier-drone.jpg" alt="Pacific Beach Crystal Pier aerial">
                <img class="lazy surfimg" src="https://ik.imagekit.io/y0qivtggs/surfing_MdZmFDH1go.jpg?tr=w-400,h-550,bl-30,q-50" data-src="./resources/images/sidebar/surfing.jpg" alt="Pacific Beach Surfer in a barrel">
                <img class="lazy wavesimg" src="https://ik.imagekit.io/y0qivtggs/waves_PVdcIIMpm.jpg?tr=w-400,h-300,bl-30,q-50" data-src="./resources/images/sidebar/waves.jpg" alt="waves in pacific beach">
                <img class="lazy petcoparkimg" src="https://ik.imagekit.io/y0qivtggs/petco-park_y_9_zOB6Lq.jpg?tr=w-400,h-300,bl-30,q-50" data-src="./resources/images/sidebar/petco-park.jpg" alt="Aerial image of Petco Park">
            </div>
        </div>
    </section>
        ...
        <div class="content-wrap2">
            <main class="content2">
                <article>
                    ...
                    <img class="lazy ryanimg" data-src="./resources/images/agents/ryan-pearson.png" alt="Ryan Pearson Pacific Beach realtor">
                    <p class="buying-text2">
                        ...
                        <br><br>
                        “Why Should I use PacificBeachHomes when there are sites like Zillow?”
                        This is the most important question I asked myself when building the site. Zillow is an amazing website with tons of information. It revolutionized real estate by providing (what used to be private) information to anyone with access to the internet. Zillow has the entire US housing market mapped out. Even if a home is not for sale on the active market, you can see when it last sold, and for how much!
                        <br><br>
                        Zillow is a great site. I am not trying to compete with it. However, once you’ve decided on a specific neighborhood or town, like Pacific Beach, Zillow can’t give you behind the scenes insight on the community. Knowing about upcoming “off market” Pacific Beach homes for sale and a lifetime of experiences to share about the town is important! Algorithms predicting a “zestimate”, and a “walkscore” are nice, but there’s so much more to know about each neighborhood of Pacific Beach. This is where <a href="">PacificBeachHomes.com</a> comes in.
                    </p>
                </article>
            </main>
        </div>
    ...
    <section id="section5">
        <div class="content-wrap3">
            <main class="content3">
                <article>
                    <h2>How Can Pacific Beach Homes Help You?</h2>
                    <p>
                        Talking to an experienced real estate agent with knowledge of the area is extremely important when buying or selling a home in Pacific Beach. Finding the right homes for sale in Pacific beach is important, whether it’s online or offline, but it’s only the first step. You need help with the real estate contracts, knowing how and when to negotiate, and the steps of buying or selling a home. You also want someone who knows more than the “property details write-up” about the house and area you are looking at.
                    </p>
                    <br>
                    <br>
