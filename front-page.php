...
<div class="mid-wrap clearfix">
        ...
        <div class="content-wrap">
            ...
            <main class="content">
                ...
                <article>
                    ...
                    <h2 class="slide-up">Can I afford a home in Pacific Beach?</h2>
                    ...
                    <h2 class="slide-up">What types of homes are for sale in Pacific Beach?</h2>
                    ...
                    <h2 class="slide-up">Which Pacific Beach neighborhood is right for me?</h2>
    ...
    <section id="section4">
        <div class="content-wrap2">
            <main class="content2">
                <article>
                    <h2 class="slide-up">Why Choose Pacific Beach Homes and Ryan Pearson?</h2>
                    <figure class="ryanimg-container">
                        <div class="ryanimg slide-up"  alt="Ryan Pearson Pacific Beach realtor"></div>
                    </figure>
    ...
    <section id="section5">
        <div class="content-wrap3">
            <main class="content3">
                <article>
                    <h2 class="slide-up">How can Pacific Beach Homes help you?</h2>
                    <p>
                    ...
                    <br>
                    <br>
                    <h3 class="slide-up">What services does Pacific Beach Homes Provide?</h3>
                    <ul>
                        <li class="slide-up">Finding and scheduling the right homes to see</li>
                        <li class="slide-up">Analyzing homes – for occupying, investing, renting and selling</li>
                        <li class="slide-up">Connecting you with a great lender</li>
                        <li class="slide-up">Making an offer after understanding the market</li>
                        <li class="slide-up">Escrow – and explaining this process</li>
                        <li class="slide-up">Inspections – connections with inspectors and knowing when to get an inspection</li>
                        <li class="slide-up">Request for repairs</li>
                        <li class="slide-up">Appraisal</li>
                        <li class="slide-up">Getting ready to close and move into your new home!</li>
                    </ul>
                </article>
